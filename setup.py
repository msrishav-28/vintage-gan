...
setup(
    ...
    author="VintageGAN Project",
    author_email="",
    description="Controllable vintage image synthesis with conditional GANs",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/msrishav-28/vintage-gan",
    packages=find_packages(
        exclude=["tests", "notebooks", "data", "checkpoints", "logs", "outputs"]
    ),
    classifiers=[
